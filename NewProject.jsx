...
export default class NewProject extends Component {
    ...
    add(technology, projectID, courseName, semester, studentID, studentName, course, studentYear, assignmentName, assignmentDescription, assignmentPercentage, scope, description, industryLink, application, courseID, assignment, student, projectImage) {
        this.setState({
            technology: [], projectID: '', semester: '', student: [{ studentID: '', studentName: '', studentYear: '' }], course: [{ courseID: '', courseName: '' }], assignment: [{ assignmentName: '', assignmentDescription: '', assignmentPercentage: '' }],
    ...
    render() {
        console.log("Student array: ", this.state.student)
        return (
            <div>
                                            ...
                                            <div className="card-deck">
                                                <div className="card mb-4 h-100" style={{ maxWidth: 20 + 'rem' }}>
                                                    <div className="card-body">
                                                        ...
                                                        <button className="btn btn-danger" onClick={this.delete.bind(this, s.projectID)}>Delete</button> &nbsp;&nbsp;
                                                        <button className="btn btn-info" onClick={this.edit.bind(this, s.technology, s.projectID, s.semester, s.student, s.course, s.assignment, s.scope, s.description, s.industryLink, s.application)}>Edit</button>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>)}
