                                    ...
                                    <div className='card-body'>
                                        <div className='card-header' style={{ backgroundColor: 'white' }}>
                                            ...
                                            <div className="list-group">
                                                ...
                                                {unique.map((s, index) =>
                                                    <button key={index} type='button' onClick={this.semester_search.bind(this, this.state.semester)} value={s}
                                        ...
                                        <div className='card-header' style={{ backgroundColor: 'white' }}>
                                            ...
                                            <div className="list-group">
                                                ...
                                                {unique1.map((s, index) =>
                                                    <button key={index} type='button' onClick={this.course_search.bind(this, this.state.course.map(s => s.courseID))} value={s}
                                                        className="list-group-item list-group-item-action">{s}</button>
                                                )}
                                            </div>
                                        </div>
